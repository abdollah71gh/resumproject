                ...
                <div class="row ">
                    <div class="col-12">
                        <div class="page-header">
                            <h4 class="page-title">ایجاد نمونه کار  کاربران </h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div style="direction: rtl;">
                            <div class="card ">
                                ...
                                <div class="card-body bg-light">
                                    <form method="post" action="{{route('admin.samples.store')}}">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('lik') is-invalid @enderror"
